...
export const PreLoadingSVG = (props: { brand: string }) => {
  const brandLoaders = {
    ...
    lowes: (
      <div className='PreLoadingSVG__lowes'>
        <span>
        ...
        <>
          <svg className='PreLoadingSVG__loader' version='1.1' baseProfile='tiny' id='Layer_1' xmlns='http://www.w3.org/2000/svg' xmlnsXlink='http://www.w3.org/1999/xlink' x='0px' y='0px' viewBox='0 0 1200 1200' xmlSpace='preserve'>
            <g id='flower-container' data-svg-origin='610.2215728759766 492.3915252685547' style={{ transform: 'matrix(1, 0, 0, 1, 0, 0)' }}>
              ...
              <polygon className='PreLoadingSVG__loader__inner-rect' fill='#BED600' path='' points='544,560 509,452 452,530' />
              <polygon className='PreLoadingSVG__loader__inner-rect' fill='#E9994A' path='' points='509,452 600,386 509,357' />
              <polygon className='PreLoadingSVG__loader__inner-rect' fill='#FFF' points='600,386 691,452 656,560 544,560 509,452' id='pentagon' data-svg-origin='600 481.7' style={{ transform: 'matrix(1, 0, 0, 1, 0, 0)' }} /></g>
            <g id='text' className='PreLoadingSVG__loader__text' data-svg-origin='613.5000228881836 900.3800109863281' style={{ opacity: '1', transform: 'matrix(1, 0, 0, 1, 0, 0)' }}>
