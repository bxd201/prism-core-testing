        ...
        <div className='swatch-content__button-group'>
          {colorIsInLivePalette ? (
            ...
            <button
              ...
              title={at(messages, 'ADD_TO_PALETTE')[0].replace(
                '{name}',
          ...
          <InfoButton ref={(el) => swatchContentRefs.current.push(el)} color={color} />
        </div>
      </div>
      <div className={`${baseClass}__label swatch-content$__name-number`}>
        <p className={`${baseClass}__label--number`}>
