      ...
      <ImageColorPicker
        ...
        pinRenderer={(props) => (
          <ColorPin
            ...
            labelContent={(color) => (
              <>
                <p style={{ lineHeight: '1.1rem', whiteSpace: 'nowrap' }}>
...
| removeButtonContent | `JSX.Element`                       | Content to be displayed in the remove button.                                   | Optional |`json<br>{<br>  <br>"firstName"<br>: <br>"John"<br>,<br>  <br>"lastName"<br>: <br>"Smith"<br>,<br>  <br>"age"<br>: <br>25<br><br>}<br>``` | Defines text shown with add button on color swatches. Any instances of the `{name}` keyword in this property will be replaced with the name of the associated color. |