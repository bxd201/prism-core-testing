import { Block, ChunkData, Items, ShapeAlignment, ShapeLevel } from '../../components/color-wall/types'

// To avoid DRY this function is needed
const addSwatches = (chunk: ChunkData): ChunkData => ({
  ...chunk,
  swatchesRef: {
    current: chunk.data.children
      .flatMap((children: Items) => children)
      .map((id: number | string) => ({
        swatches: [document.createElement('button')],
        id
      }))
  }
})

export const mockChunkArr: ChunkData[] = [
  {
    data: {
      type: 'CHUNK' as Block.Chunk,
      children: [
      ...
      props: {
        spaceH: 0.25,
        spaceV: 0.25,
        align: 'start' as ShapeAlignment
      },
      titles: [
        {
          align: 'left' as ShapeAlignment,
          level: 1 as ShapeLevel,
          value: 'Neutral'
        }
      ],
      childProps: {}
    ...
    id: ' 0_0_0_0_0',
    chunkRef: { current: document.createElement('div') },
    swatchesRef: {
      current: []
    }
  },
